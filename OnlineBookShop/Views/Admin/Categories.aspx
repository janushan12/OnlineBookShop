        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Name" autocomplete="off" runat="server" id="CatNameTb" />
                </div>
                <div class="mb-3">
                    <label for="" class="form-label text-success">Category Description</label>
                    <input type="text" class="form-control" placeholder="Description" autocomplete="off" runat="server" id="CatDescTb" />
                </div>
                <div class="row">
            ...
            <div class="col-md-8">
                <asp:GridView ID="CategoriesList" runat="server" class="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="CategoriesList_SelectedIndexChanged">
